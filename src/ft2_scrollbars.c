...
scrollBar_t scrollBars[NUM_SCROLLBARS] =
{
	...
	*/
	...
	{ 484,  3, 17, 80, SCROLLBAR_VERTICAL, SCROLLBAR_DYNAMIC_THUMB_SIZE, sbPalListPos },
	...
	//x,   y,  w,  h,   type,               style                         funcOnDown
	{ 483, 28, 18, 44, SCROLLBAR_VERTICAL, SCROLLBAR_DYNAMIC_THUMB_SIZE, sbMidiInputSetPos },
	{ 483,115, 18, 43, SCROLLBAR_VERTICAL, SCROLLBAR_DYNAMIC_THUMB_SIZE, sbMidiOutputSetPos },
#endif
...
#ifdef HAS_MIDI
	setScrollBarPageLength(SB_MIDI_INPUT_SCROLL, 6);
	setScrollBarEnd(SB_MIDI_INPUT_SCROLL, 1);
	setScrollBarPageLength(SB_MIDI_OUTPUT_SCROLL, 6);
	setScrollBarEnd(SB_MIDI_OUTPUT_SCROLL, 1);
#endif
