...
extern const pattCoordsMouse_t pattCoordMouseTable[2][2][3];
extern const uint8_t noteTab1[96];
extern const uint8_t noteTab2[96];
extern const uint8_t hex2Dec[256];
extern const pattCoord_t pattCoordTable[2][2][3];
extern const pattCoord2_t pattCoord2Table[2][2][3];
extern const markCoord_t markCoordTable[2][2][3];
