...
typedef struct ts_file_browser { char directory[TS_PATH_MAX_BYTES+1U];ts_browser_entry entries[TS_BROWSER_MAX_ENTRIES];size_t count,selected,scroll;ts_text_edit filename;ts_browser_mode mode;char error[128];ft2_ui_scrollbar scrollbar; } ts_file_browser;
